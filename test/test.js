...
//             await nft.connect(addr1).publicMint(amount,, {value: ethers.utils.parseEther(`${price*amount}`)})

//             const addr2Balance = await nft.balanceOf(addr2.address);
//             await nft.connect(addr2).publicMint(amount,, {value: ethers.utils.parseEther(`${price*amount}`)})
